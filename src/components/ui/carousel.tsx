	...
	({ className, variant = "outline", size = "icon", ...props }, ref) => {
		...
		return (
			<Button
				...
				size={size}
				className={cn(
					"group h-8 w-8 rounded-full transition-colors duration-200 hover:bg-primary",
...
const DotButtons = () => {
	...
	return (
		<div className="absolute left-1/2 top-0 z-30 flex -translate-x-1 gap-x-2 pl-1 pt-1">
